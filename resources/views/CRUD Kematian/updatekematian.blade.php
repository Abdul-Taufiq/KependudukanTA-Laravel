...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800"><i class="fa fa-edit"></i> Edit Data Kematian</h1>

<div class="card shadow mb-4">
        <div class="card-body">

        <form action="  {{ url('kematian/'.$kematian->id_kematian) }} " method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="no_kematian" autocomplete="off" required maxlength="16"
                        class="form-control @error('no_kematian') is-invalid @enderror" autofocus value="{{ old('no_kematian', $kematian->no_kematian) }}">
                        {{-- Erorr Message --}}
                        @error('no_kematian')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tgl_kematian" id="tgl_kematian" required onchange="autofill()"
                        data-provide="datepicker" required value="{{ old('tgl_kematian', $kematian->tgl_kematian->format('d-m-Y')) }}"
                ...
                <div class="form-group">
                        <label>Umur</label>
                        <input type="text" name="umur" id="umur" readonly="" autocomplete="off" maxlength="4" required value="{{ old('umur', $kematian->umur) }}"
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="tempat_kematian" autocomplete="off" maxlength="200" required value="{{ old('tempat_kematian', $kematian->tempat_kematian) }}" 
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="keterangan" autocomplete="off" maxlength="200" required value="{{ old('keterangan', $kematian->keterangan) }}"
