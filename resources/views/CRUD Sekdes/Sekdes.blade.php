...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Tabel Sekretaris Desa</h1>
...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<a class="btn btn-primary btn-icon-split btn-sm mb-2" href="sekdes/create">
			<span class="icon text-white-50">
				<i class="fa fa-plus-circle" aria-hidden="true"></i>
			</span>
			<span class="text">Tambah Data</span>
		</a>
		<a href="{{ route('cetak-sekdes') }}" class="btn btn-primary btn-icon-split btn-sm mb-2" target="_blank">
			<span class="icon text-white-50">
		...
		<div class="d-inline" style="float: right; overflow: hidden; padding: 2px">
			...
			class="datepicker" style="width: 150px;" placeholder="DD-MM-YYYY" maxlength="10">
			<a href="" onclick="this.href='/sekdes/cetak/cetakdatasekdes-pertanggal/'+ document.getElementById('tglawal').value +'/'+ document.getElementById('tglakhir').value" class="btn btn-primary btn-icon-split btn-sm mb-2" target="_blank" >
				<span class="icon text-white-50">
					<i class="fa fa-print" aria-hidden="true"></i>
				</span>
					...
					@foreach ($data as $item)
						<tr>
							<td style="width: 10px; text-align:center;">
								...
								{{-- BUTTON UBAH --}}
								<a href=" {{ url('sekdes/'.$item->id_sekdes.'/edit') }} " class="btn btn-primary btn-icon-split" style="width: 35px; height: 35px">
									<span class="icon text-white-50">
								...
								{{-- BUTTON HAPUS --}}
								<form action="{{ url('sekdes/'.$item->id_sekdes) }}" method="post" onsubmit="return confirm('Yakin Hapus Data?')" class="d-inline">
