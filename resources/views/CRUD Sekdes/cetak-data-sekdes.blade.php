...
<html>
<head>
	<title>Desa Ngilen | Cetak Data Sekdes</title>
	<style type="text/css">
		body{
	...
	<div class="form-group">
			...
			<table class="header">
				<tr>
					...
					<td width="25%"></td>
						...
						<h3 style="text-align: center;">LAPORAN DATA SEKRETARIS DESA</h3>
		{{-- TANGGAL CETAK --}}
		Dicetak Pada Tanggal : <?php echo date("d-m-Y"); ?> <br>
		Jumlah Data : {{ $cetakdatasekdes->count('pivot.id_sekdes') }}
		<br><br>
		<table class="static" border="1" id="" width="100%" cellspacing="0" style="color: #000;" rules="all">
			<thead>
				...
				<tbody>
					<?php $i = 1; ?>
					@foreach ($cetakdatasekdes as $item)
					<tr>
