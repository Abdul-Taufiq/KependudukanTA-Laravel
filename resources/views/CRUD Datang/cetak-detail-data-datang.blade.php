...
<html>
<head>
	<title>Desa Ngilen | Cetak Detail Data Datang</title>
	<style type="text/css">
		body{
			...
			<div class="form-group">
				<div>
					...
					<table class="header">
						...
						<h3 style="text-align: center;">LAPORAN DETAIL DATA DATANG</h3>
				{{-- TANGGAL CETAK --}}
				Dicetak Pada Tanggal : <?php echo date("d-m-Y"); ?> <br>
				Jumlah Data : {{ $datang->penduduk->count('pivot.id_datang') }}
				<br><br>
