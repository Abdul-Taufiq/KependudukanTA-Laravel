...
<div class="container-fluid">
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800"><i class="fa fa-plus-circle"></i> Tambah Data Datang</h1>

	<div class="card shadow mb-4">
		<div class="card-body">

			<form action="  {{ url('datang') }} " method="post" enctype="multipart/form-data">
				{{-- CSRF TOKEN --}}
				@csrf
				<div class="form-group">
					<label>Nomor Datang</label>
					<input type="text" name="no_datang" autocomplete="off" required maxlength="30" value="{{ old('no_datang', $nomer) }}"
				...
				<div class="form-group">
					...
					<input type="text" name="tgl_datang" id="tgl_datang" required 
						data-provide="datepicker" required value="{{ old('tgl_datang') }}"
